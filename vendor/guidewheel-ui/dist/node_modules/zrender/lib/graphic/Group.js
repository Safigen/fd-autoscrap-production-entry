...
import c from "../Element.js";
import u from "../core/BoundingRect.js";
var _ = (function(a) {
  v(o, a);
  function o(r) {
  ...
  return o.prototype.childrenRef = function() {
    ...
    var t = this.__zr, e = this._children, n = l(e, r);
    ...
    for (var t = new u(0, 0, 0, 0), e = r || this._children, n = [], i = null, h = 0; h < e.length; h++) {
      var p = e[h];
      if (!(p.ignore || p.invisible)) {
        var s = p.getBoundingRect(), f = p.getLocalTransform(n);
        f ? (u.applyTransform(t, s, f), i = i || t.clone(), i.union(t)) : (i = i || s.clone(), i.union(s));
      }
    }
    return i || t;
  }, o;
})(c);
_.prototype.type = "group";
export {
  _ as default
};
