...
import { Root as at, Anchor as dt, createPopperScope as _e, Content as ut, Arrow as pt } from "../../react-popper/dist/index.js";
import { Portal as ft } from "../node_modules/@radix-ui/react-portal/dist/index.js";
import { Primitive as M } from "../../react-primitive/dist/index.js";
import { createSlot as mt } from "../node_modules/@radix-ui/react-slot/dist/index.js";
...
import { VISUALLY_HIDDEN_STYLES as gt } from "../../react-visually-hidden/dist/index.js";
import { hideOthers as St } from "../../../aria-hidden/dist/es2015/index.js";
import wt from "../../../react-remove-scroll/dist/es2015/Combination.js";
import { jsx as m, jsxs as ce, Fragment as Te } from "react/jsx-runtime";
var Ct = [" ", "Enter", "ArrowUp", "ArrowDown"], yt = [" ", "Enter"], J = "Select", [ae, de, xt] = nt(J), [te] = rt(J, [
  xt,
  _e
]), ue = _e(), [It, j] = te(J), [Tt, Pt] = te(J), Ne = (n) => {
  const {
    __scopeSelect: c,
    children: e,
    open: i,
    ...
    required: R,
    form: T
  } = n, a = ue(c), [v, y] = t.useState(null), [d, h] = t.useState(null), [A, O] = t.useState(!1), oe = st(p), [b, L] = Ee({
    prop: i,
    defaultProp: l ?? !1,
    onChange: u,
    caller: J
  ...
  return /* @__PURE__ */ m(at, { ...a, children: /* @__PURE__ */ ce(
    It,
    {
      required: R,
      scope: c,
...
var Me = "SelectTrigger", Ae = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, disabled: i = !1, ...l } = n, u = ue(e), r = j(Me, e), s = r.disabled || i, o = V(c, r.onTriggerChange), p = de(e), g = t.useRef("touch"), [C, P, R] = tt((a) => {
      const v = p().filter((h) => !h.disabled), y = v.find((h) => h.value === r.value), d = ot(v, a, y);
    ...
    return /* @__PURE__ */ m(dt, { asChild: !0, ...u, children: /* @__PURE__ */ m(
      M.button,
      {
        type: "button",
        role: "combobox",
        ...
        onKeyDown: E(l.onKeyDown, (a) => {
          const v = C.current !== "";
          !(a.ctrlKey || a.altKey || a.metaKey) && a.key.length === 1 && P(a.key), !(v && a.key === " ") && Ct.includes(a.key) && (T(), a.preventDefault());
        })
      }
    ) });
  }
...
var Oe = "SelectValue", De = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, className: i, style: l, children: u, placeholder: r = "", ...s } = n, o = j(Oe, e), { onValueNodeHasChildrenChange: p } = o, g = u !== void 0, C = V(c, o.onValueNodeChange);
    return Y(() => {
      p(g);
    }, [p, g]), /* @__PURE__ */ m(
      M.span,
      {
        ...
        children: et(o.value) ? /* @__PURE__ */ m(Te, { children: r }) : u
      }
    );
  }
);
De.displayName = Oe;
var Rt = "SelectIcon", Le = t.forwardRef(
  (n, c) => {
...
Le.displayName = Rt;
var Et = "SelectPortal", ke = (n) => /* @__PURE__ */ m(ft, { asChild: !0, ...n });
ke.displayName = Et;
  ...
  (n, c) => {
    ...
    if (Y(() => {
      ...
      return u ? be.createPortal(
        /* @__PURE__ */ m(Be, { scope: n.__scopeSelect, children: /* @__PURE__ */ m(ae.Slot, { scope: n.__scopeSelect, children: /* @__PURE__ */ m("div", { children: n.children }) }) }),
        u
      ) : null;
    }
...
Ve.displayName = Q;
var D = 10, [Be, q] = te(Q), bt = "SelectContentImpl", _t = mt("SelectContent.RemoveScroll"), He = t.forwardRef(
  (n, c) => {
    const {
      __scopeSelect: e,
      ...
      //
      ...y
    } = n, d = j(Q, e), [h, A] = t.useState(null), [O, oe] = t.useState(null), b = V(c, (f) => A(f)), [L, K] = t.useState(null), [X, B] = t.useState(
      null
    ...
    t.useEffect(() => {
      if (h) {
        ...
        const I = (x) => {
          ...
          f.x <= 10 && f.y <= 10 ? x.preventDefault() : h.contains(x.target) || U(!1), document.removeEventListener("pointermove", I), z.current = null;
        };
    ...
    const [pe, se] = tt((f) => {
      const I = H().filter((S) => !S.disabled), N = I.find((S) => S.ref.current === document.activeElement), x = ot(I, f, N);
      x && setTimeout(() => x.ref.current.focus());
    }), fe = t.useCallback(
      (f, I, N) => {
        const x = !F.current && !N;
        (d.value !== void 0 && d.value === I || x) && (K(f), x && (F.current = !0));
      },
      [d.value]
    ), me = t.useCallback(() => h == null ? void 0 : h.focus(), [h]), ee = t.useCallback(
      (f, I, N) => {
        const x = !F.current && !N;
        (d.value !== void 0 && d.value === I || x) && B(f);
      },
      [d.value]
    ...
    return /* @__PURE__ */ m(
      Be,
      {
        ...
        isPositioned: G,
        searchRef: pe,
        children: /* @__PURE__ */ m(wt, { as: _t, allowPinchZoom: !0, children: /* @__PURE__ */ m(
          it,
          {
            asChild: !0,
            trapped: d.open,
...
He.displayName = bt;
var Nt = "SelectItemAlignedPosition", We = t.forwardRef((n, c) => {
  const { __scopeSelect: e, onPlaced: i, ...l } = n, u = j(Q, e), r = q(Q, e), [s, o] = t.useState(null), [p, g] = t.useState(null), C = V(c, (b) => g(b)), P = de(e), R = t.useRef(!1), T = t.useRef(!0), { viewport: a, selectedItem: v, selectedItemText: y, focusSelectedItem: d } = r, h = t.useCallback(() => {
...
We.displayName = Nt;
var Mt = "SelectPopperPosition", Se = t.forwardRef((n, c) => {
  const {
    __scopeSelect: e,
    align: i = "start",
...
Se.displayName = Mt;
var [At, Pe] = te(Q, {}), we = "SelectViewport", Fe = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, nonce: i, ...l } = n, u = q(we, e), r = Pe(we, e), s = V(c, u.onViewportChange), o = t.useRef(0);
...
Fe.displayName = we;
var Ue = "SelectGroup", [Ot, Dt] = te(Ue), Ke = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, ...i } = n, l = Ie();
    return /* @__PURE__ */ m(Ot, { scope: e, id: l, children: /* @__PURE__ */ m(M.div, { role: "group", "aria-labelledby": l, ...i, ref: c }) });
  }
);
Ke.displayName = Ue;
var Ge = "SelectLabel", ze = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, ...i } = n, l = Dt(Ge, e);
    return /* @__PURE__ */ m(M.div, { id: l.id, ...i, ref: c });
  }
);
ze.displayName = Ge;
var ie = "SelectItem", [Lt, Ye] = te(ie), je = t.forwardRef(
  (n, c) => {
    const {
      __scopeSelect: e,
      value: i,
      ...
      textValue: u,
      ...r
    } = n, s = j(ie, e), o = q(ie, e), p = s.value === i, [g, C] = t.useState(u ?? ""), [P, R] = t.useState(!1), T = V(
      c,
      (d) => {
        var h;
            ...
            children: /* @__PURE__ */ m(
              M.div,
              {
                ...
                onKeyDown: E(r.onKeyDown, (d) => {
                  var A;
                  ((A = o.searchRef) == null ? void 0 : A.current) !== "" && d.key === " " || (yt.includes(d.key) && y(), d.key === " " && d.preventDefault());
                })
              }
            )
          }
...
var re = "SelectItemText", qe = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, className: i, style: l, ...u } = n, r = j(re, e), s = q(re, e), o = Ye(re, e), p = Pt(re, e), [g, C] = t.useState(null), P = V(
      c,
      (y) => C(y),
      o.onItemTextChange,
      (y) => {
...
Ze.displayName = Xe;
var Ce = "SelectScrollUpButton", kt = t.forwardRef((n, c) => {
  const e = q(Ce, n.__scopeSelect), i = Pe(Ce, n.__scopeSelect), [l, u] = t.useState(!1), r = V(c, i.onScrollButtonChange);
  return Y(() => {
...
kt.displayName = Ce;
var ye = "SelectScrollDownButton", Vt = t.forwardRef((n, c) => {
  const e = q(ye, n.__scopeSelect), i = Pe(ye, n.__scopeSelect), [l, u] = t.useState(!1), r = V(c, i.onScrollButtonChange);
  return Y(() => {
    if (e.viewport && e.isPositioned) {
      let s = function() {
...
}), Bt = "SelectSeparator", Je = t.forwardRef(
  (n, c) => {
    const { __scopeSelect: e, ...i } = n;
...
var xe = "SelectArrow", Ht = t.forwardRef(
  (n, c) => {
    ...
    return u.open && r.position === "popper" ? /* @__PURE__ */ m(pt, { ...l, ...i, ref: c }) : null;
  }
);
Ht.displayName = xe;
var Wt = "SelectBubbleInput", Qe = t.forwardRef(
  ({ __scopeSelect: n, value: c, ...e }, i) => {
    const l = t.useRef(null), u = V(i, l), r = vt(c);
    return t.useEffect(() => {
      const s = l.current;
      if (!s) return;
...
var uo = Ne, po = Ae, fo = De, mo = Le, ho = ke, vo = Ve, go = Fe, So = Ke, wo = ze, Co = je, yo = qe, xo = Ze, Io = Je;
export {
  vo as Content,
  So as Group,
  mo as Icon,
