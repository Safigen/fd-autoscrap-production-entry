...
import w from "../Element.js";
import p from "../core/BoundingRect.js";
import { keys as _, extend as P, createObject as B } from "../core/util.js";
import { STYLE_CHANGED_BIT as c, REDRAW_BIT as E } from "./constants.js";
var m = "__zr_style_" + Math.round(Math.random() * 10), A = {
  shadowBlur: 0,
  shadowOffsetX: 0,
  shadowOffsetY: 0,
  shadowColor: "#000",
...
A[m] = !0;
var T = ["z", "z2", "invisible"], Y = ["invisible"], L = (function(a) {
  M(i, a);
  function i(t) {
    return a.call(this, t) || this;
  }
  return i.prototype._init = function(t) {
    for (var e = _(t), r = 0; r < e.length; r++) {
      var o = e[r];
    ...
    if (this.ignore || this.invisible || this.style.opacity === 0 || this.culling && D(this, t, e) || n && !n[0] && !n[3])
      return !1;
    ...
    return typeof t == "string" ? this.style[t] = e : P(this.style, t), this.dirtyStyle(), this;
    ...
    t[m] || (t = this.createStyle(t)), this.__inHover ? this.__hoverStyle = t : this.style = t, this.dirtyStyle();
    ...
    t.style && !e.style && (e.style = this._mergeStyle(this.createStyle(), this.style)), this._savePrimaryToNormal(t, e, T);
    ...
    if (e && e.style ? n ? o ? s = e.style : (s = this._mergeStyle(this.createStyle(), r.style), this._mergeStyle(s, e.style)) : (s = this._mergeStyle(this.createStyle(), o ? this.style : r.style), this._mergeStyle(s, e.style)) : h && (s = r.style), s)
      if (n) {
        ...
        if (this.style = this.createStyle(h ? {} : u), h)
          for (var g = _(u), y = 0; y < g.length; y++) {
            var l = g[y];
            l in s && (s[l] = s[l], this.style[l] = u[l]);
          }
        for (var S = _(s), y = 0; y < S.length; y++) {
          var l = S[y];
        ...
        this.useStyle(s);
    for (var R = this.__inHover ? Y : T, y = 0; y < R.length; y++) {
      var l = R[y];
    ...
    var t = i.prototype;
    t.type = "displayable", t.invisible = !1, t.z = 0, t.z2 = 0, t.zlevel = 0, t.culling = !1, t.cursor = "pointer", t.rectHover = !1, t.incremental = !1, t._rect = null, t.dirtyRectTolerance = 0, t.__dirty = E | c;
  })(), i;
})(w), v = new p(0, 0, 0, 0), d = new p(0, 0, 0, 0);
function D(a, i, t) {
  return v.copy(a.getBoundingRect()), a.transform && v.applyTransform(a.transform), d.width = i, d.height = t, !v.intersect(d);
}
export {
  b as DEFAULT_COMMON_ANIMATION_PROPS,
  A as DEFAULT_COMMON_STYLE,
  L as default
};
