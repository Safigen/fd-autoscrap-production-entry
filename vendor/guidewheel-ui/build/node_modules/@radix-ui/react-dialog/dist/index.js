...
import { createContext as V, createContextScope as q } from "../../react-context/dist/index.js";
...
import { Portal as Z } from "../node_modules/@radix-ui/react-portal/dist/index.js";
...
var v = "Dialog", [I, Ne] = q(v), [ee, u] = I(v), x = (e) => {
  const {
    __scopeDialog: o,
    children: n,
    open: a,
...
var B = "DialogTitleWarning", [Pe, j] = V(B, {
  contentName: f,
  titleName: y,
  docsSlug: "dialog"
}), ie = ({ titleId: e }) => {
