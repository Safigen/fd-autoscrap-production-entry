import { create as c, mul as l, copy as d, invert as x, rotate as R, identity as P } from "./matrix.js";
...
var f = [], h = [], v = c(), p = Math.abs, A = (function() {
  ...
  return a.prototype.getLocalTransform = function(r) {
    ...
    o = o || c(), t ? this.getLocalTransform(o) : g(o), r && (t ? l(o, r, o) : d(o, r)), this.transform = o, this._resolveGlobalScaleRatio(o);
    ...
    this.invTransform = this.invTransform || c(), x(this.invTransform, r);
    ...
    if (o || n || u || T) {
      ...
      t[4] = t[5] = 0;
    return t[0] = s, t[3] = i, t[1] = X * s, t[2] = m * i, y && R(t, t, y), t[4] += o + S, t[5] += n + b, t;
