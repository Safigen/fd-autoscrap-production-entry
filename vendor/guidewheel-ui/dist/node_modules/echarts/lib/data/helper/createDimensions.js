...
function mn(e, i) {
  ...
  M(d, function(a) {
    ...
    if (l !== !1) {
      ...
      M(l, function(Z, w) {
        var h = p(Z);
        if (F && n.type != null && (h.type = n.type), _(z(h, n), r, w), h.name == null && o) {
          var y = o[w];
          !T(y) && (y = {
            name: y
          }), h.name = h.displayName = y.name, h.defaultTooltip = y.defaultTooltip;
        }
        v && z(h.otherDims, v);
      });
    }
...
//# sourceMappingURL=createDimensions.js.map
