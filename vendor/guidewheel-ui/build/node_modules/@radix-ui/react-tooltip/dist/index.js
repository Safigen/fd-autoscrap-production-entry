...
import { Portal as te } from "@radix-ui/react-portal";
...
var L = "TooltipTrigger", U = s.forwardRef(
  (t, o) => {
    ...
    return s.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ f(Z, { asChild: !0, ...l, children: /* @__PURE__ */ f(
      oe.button,
      {
