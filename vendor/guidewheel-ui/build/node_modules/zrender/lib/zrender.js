import p from "./core/env.js";
import { guid as S, keys as H, retrieve2 as A } from "./core/util.js";
import D from "./Handler.js";
import w from "./Storage.js";
import k, { getTime as c } from "./animation/Animation.js";
import M from "./dom/HandlerProxy.js";
import { lum as m } from "./tool/color.js";
import { DARK_MODE_THRESHOLD as _ } from "./config.js";
import z from "./graphic/Group.js";
/*!
...
var F = (function() {
  function t(e, r, i) {
    ...
    var a = new w(), n = i.renderer || "canvas";
    if (h[n] || (n = H(h)[0]), process.env.NODE_ENV !== "production" && !h[n])
      throw new Error("Renderer '" + n + "' is not imported. Please import it first.");
    i.useDirtyRect = i.useDirtyRect == null ? !1 : i.useDirtyRect;
    var o = new h[n](r, a, i, e), f = i.ssr || o.ssrOnly;
    this.storage = a, this.painter = o;
    var v = !p.node && !p.worker && !f ? new M(o.getViewportRoot(), o.root) : null, d = i.useCoarsePointer, g = d == null || d === "auto" ? p.touchEventsSupported : !!d, R = 44, l;
    g && (l = A(i.pointerSize, R)), this.handler = new D(a, o, v, o.root, l), this.animation = new k({
      stage: {
  ...
  return t.prototype.add = function(e) {
    ...
    if (!this._disposed) {
      for (var e = this.storage.getRoots(), r = 0; r < e.length; r++)
        e[r] instanceof z && e[r].removeSelfFromZr(this);
      this.storage.delAllRoots(), this.painter.clear();
    }
  }, t.prototype.dispose = function() {
    this._disposed || (this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this.animation = this.storage = this.painter = this.handler = null, this._disposed = !0, P(this.id));
  }, t;
})();
function N(t, e) {
  var r = new F(S(), t, e);
...
export {
  W as getElementSSRData,
  N as init,
  V as registerPainter,
  K as registerSSRDataGetter
};
